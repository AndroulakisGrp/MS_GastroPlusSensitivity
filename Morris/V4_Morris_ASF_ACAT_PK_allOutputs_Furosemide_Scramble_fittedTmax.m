...
MATLABfile='Morris_Furosemide_r20_fittedTmax_50pct_Replicate3.mat';


%% Set up for automation script
automation = 'C:\Users\megerle\Desktop\IPA_Group\Automation_Scripts\Parameter_Sensitivity\Morris\Final\GastroPlus_automation_v2.exe';
...
[values,names] = xlsread('input_parameters_v3.xlsx',4);
...
lower_bound=0.5*nominal_values; % specify lower bound
upper_bound=1.5*nominal_values; % specify upper bound
...
%Update PK compartment parameters in GastroPlus for Base Matrix
    ...
    K13 = num2str(base_points(i,56)); %1/h
    K31 = num2str(base_points(i,57)); %1/h
...
%Save ACAT model files for Base and Auxiliary Matrix
 ...
 %Update PK compartment parameters in GastroPlus for resampling matrices
    ...
    K13 = num2str(temp(j,56)); %1/h
    K31 = num2str(temp(j,57)); %1/h
...
%end of data collection
    ...
    func_simu_EE_SigFig(j,i,:)=(alloutput_SigFig(j,:,i)-func_simu_base_SigFig(j,:))/(auxiliary_points_frac(j,i)-base_points_frac(j,i));
...
Labels={'St pH','St Vol','St Pore','St Porosity/Length','St TT',...
            ...
            'ASF C1', ' ASF C2', ' ASF C3', ' ASF C4','Renal Clearance','k13','k31'};
