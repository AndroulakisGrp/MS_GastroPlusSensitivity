...
%Selected factors based on the Morris Method for
%"V3_Morris_ASF_ACAT_PK_allOutputs_APAP_IR_20pctBounds_ScrambleReplicate1"
%for Cmax
...
%Sampled Parameters
[values,names] = xlsread('input_parameters_Sobol.xlsx',2);
...
repetition_of_sampling = 4000; % number of N, should be set to 500 or larger
...
%     phystest_A(320)=cellstr(sprintf('Ileum 3 Length = %s ',num2str((base_points(i,5)-base_points(i,5)*0.0462)/5)));
    phystest_A(106)=cellstr(sprintf('Duodenum Radius = %s ',num2str(base_points(i,1)*1.6)));
    phystest_A(149)=cellstr(sprintf('Jejunum 1 Radius = %s ',num2str(base_points(i,1)*1.5)));
    phystest_A(192)=cellstr(sprintf('Jejunum 2 Radius = %s ',num2str(base_points(i,1)*1.34)));
    phystest_A(235)=cellstr(sprintf('Ileum 1 Radius = %s ',num2str(base_points(i,1)*1.18)));
    phystest_A(278)=cellstr(sprintf('Ileum 2 Radius = %s ',num2str(base_points(i,1)*1.01)));
    phystest_A(321)=cellstr(sprintf('Ileum 3 Radius = %s ',num2str(base_points(i,1)*0.85)));
%     phystest_A(112)=cellstr(sprintf('Duodenum Transit Time = %s ',num2str(base_points(i,7)*0.0788)));
%     phystest_A(155)=cellstr(sprintf('Jejunum 1 Transit Time = %s ',num2str(base_points(i,7)*0.2879)));
%     phystest_A(198)=cellstr(sprintf('Jejunum 2 Transit Time = %s ',num2str(base_points(i,7)*0.2303)));
%     phystest_A(241)=cellstr(sprintf('Ileum 1 Transit Time = %s ',num2str(base_points(i,7)*0.1788)));
%     phystest_A(284)=cellstr(sprintf('Ileum 2 Transit Time = %s ',num2str(base_points(i,7)*0.1303)));
%     phystest_A(327)=cellstr(sprintf('Ileum 3 Transit Time = %s ',num2str(base_points(i,7)*0.0939)));
...
%     phystest_A(9)=cellstr(sprintf('C1Alpha =  %s ',num2str(base_points(i,14))));
    phystest_A(10)=cellstr(sprintf('C2Alpha =  %s ',num2str(base_points(i,6))));
...
%Update PK compartment parameters in GastroPlus for Base Matrix
    ...
    Body_weight = num2str(base_points(i,2)); %kg. Do not set this to 0, G+ will have an error and set weight to 70
    Blood_Plasma_Conc_Ratio = nah;
    Exp_Plasma_Fup = nah; % %
    CL = num2str(base_points(i,3)); %L/h
    Vc = num2str(base_points(i,4)); %L/kg
    K12 = num2str(base_points(i,5)); %1/h
    K21 = nah; %1/h
    K13 = nah; %1/h
    K31 = nah; %1/h
...
%     phystest_B(146)=cellstr(sprintf('Jejunum 1 pH = %s ',num2str(base_points(i,10))));
...
%     phystest_B(320)=cellstr(sprintf('Ileum 3 Length = %s ',num2str((base_points(i,5)-base_points(i,5)*0.0462)/5)));
    phystest_B(106)=cellstr(sprintf('Duodenum Radius = %s ',num2str(base_points(i,1)*1.6)));
    phystest_B(149)=cellstr(sprintf('Jejunum 1 Radius = %s ',num2str(base_points(i,1)*1.5)));
    phystest_B(192)=cellstr(sprintf('Jejunum 2 Radius = %s ',num2str(base_points(i,1)*1.34)));
    phystest_B(235)=cellstr(sprintf('Ileum 1 Radius = %s ',num2str(base_points(i,1)*1.18)));
    phystest_B(278)=cellstr(sprintf('Ileum 2 Radius = %s ',num2str(base_points(i,1)*1.01)));
    phystest_B(321)=cellstr(sprintf('Ileum 3 Radius = %s ',num2str(base_points(i,1)*0.85)));
%     phystest_B(112)=cellstr(sprintf('Duodenum Transit Time = %s ',num2str(auxiliary_points(i,7)*0.0788)));
%     phystest_B(155)=cellstr(sprintf('Jejunum 1 Transit Time = %s ',num2str(auxiliary_points(i,7)*0.2879)));
%     phystest_B(198)=cellstr(sprintf('Jejunum 2 Transit Time = %s ',num2str(auxiliary_points(i,7)*0.2303)));
%     phystest_B(241)=cellstr(sprintf('Ileum 1 Transit Time = %s ',num2str(auxiliary_points(i,7)*0.1788)));
%     phystest_B(284)=cellstr(sprintf('Ileum 2 Transit Time = %s ',num2str(auxiliary_points(i,7)*0.1303)));
%     phystest_B(327)=cellstr(sprintf('Ileum 3 Transit Time = %s ',num2str(auxiliary_points(i,7)*0.0939)));
%     phystest_B(189)=cellstr(sprintf('Jejunum 2 pH = %s ',num2str(base_points(i,10)+0.2)));
%     phystest_B(232)=cellstr(sprintf('Ileum 1 pH = %s ',num2str(base_points(i,10)+0.4)));
%     phystest_B(275)=cellstr(sprintf('Ileum 2 pH = %s ',num2str(base_points(i,10)+0.7)));
%     phystest_B(318)=cellstr(sprintf('Ileum 3 pH = %s ',num2str(base_points(i,10)+1.2)));
 
%Update ASF Model Coefficients, C1-C4
%     phystest_B(9)=cellstr(sprintf('C1Alpha =  %s ',num2str(base_points(i,14))));
    phystest_B(10)=cellstr(sprintf('C2Alpha =  %s ',num2str(base_points(i,6))));
...
%Update PK compartment parameters in GastroPlus for Base Matrix
    ...
    Body_weight = num2str(auxiliary_points(i,2)); %kg. Do not set this to 0, G+ will have an error and set weight to 70
    Blood_Plasma_Conc_Ratio = nah;
    Exp_Plasma_Fup = nah; % %
    CL = num2str(auxiliary_points(i,3)); %L/h
    Vc = num2str(auxiliary_points(i,4)); %L/kg
    K12 = num2str(auxiliary_points(i,5)); %1/h
    K21 = nah; %1/h
    K13 = nah; %1/h
    K31 = nah; %1/h
    Renal_clearance = nah; %L/h/kg
...
%     phystest_ABi(146)=cellstr(sprintf('Jejunum 1 pH = %s ',num2str(temp(j,10))));
...
%     phystest_ABi(320)=cellstr(sprintf('Ileum 3 Length = %s ',num2str((temp(j,5)-temp(j,5)*0.0462)/5)));
    phystest_ABi(106)=cellstr(sprintf('Duodenum Radius = %s ',num2str(temp(j,1)*1.6)));
    phystest_ABi(149)=cellstr(sprintf('Jejunum 1 Radius = %s ',num2str(temp(j,1)*1.5)));
    phystest_ABi(192)=cellstr(sprintf('Jejunum 2 Radius = %s ',num2str(temp(j,1)*1.34)));
    phystest_ABi(235)=cellstr(sprintf('Ileum 1 Radius = %s ',num2str(temp(j,1)*1.18)));
    phystest_ABi(278)=cellstr(sprintf('Ileum 2 Radius = %s ',num2str(temp(j,1)*1.01)));
    phystest_ABi(321)=cellstr(sprintf('Ileum 3 Radius = %s ',num2str(temp(j,1)*0.85)));
%     phystest_ABi(112)=cellstr(sprintf('Duodenum Transit Time = %s ',num2str(temp(j,7)*0.0788)));
%     phystest_ABi(155)=cellstr(sprintf('Jejunum 1 Transit Time = %s ',num2str(temp(j,7)*0.2879)));
%     phystest_ABi(198)=cellstr(sprintf('Jejunum 2 Transit Time = %s ',num2str(temp(j,7)*0.2303)));
%     phystest_ABi(241)=cellstr(sprintf('Ileum 1 Transit Time = %s ',num2str(temp(j,7)*0.1788)));
%     phystest_ABi(284)=cellstr(sprintf('Ileum 2 Transit Time = %s ',num2str(temp(j,7)*0.1303)));
%     phystest_ABi(327)=cellstr(sprintf('Ileum 3 Transit Time = %s ',num2str(temp(j,7)*0.0939)));
%     phystest_ABi(189)=cellstr(sprintf('Jejunum 2 pH = %s ',num2str(temp(j,10)+0.2)));
%     phystest_ABi(232)=cellstr(sprintf('Ileum 1 pH = %s ',num2str(temp(j,10)+0.4)));
%     phystest_ABi(275)=cellstr(sprintf('Ileum 2 pH = %s ',num2str(temp(j,10)+0.7)));
%     phystest_ABi(318)=cellstr(sprintf('Ileum 3 pH = %s ',num2str(temp(j,10)+1.2)));

 %Update ASF Model Coefficients, C1-C4
%     phystest_ABi(9)=cellstr(sprintf('C1Alpha =  %s ',num2str(temp(j,14))));
    phystest_ABi(10)=cellstr(sprintf('C2Alpha =  %s ',num2str(temp(j,6))));
...
%Save ACAT model files for Base and Auxiliary Matrix
 ...
 %Update PK compartment parameters in GastroPlus for resampling matrices
        ...
        nah = '54875';
        %Last entered values used for parameters set to 'nah'
    Body_weight = num2str(temp(j,2)); %kg. Do not set this to 0, G+ will have an error and set weight to 70
    Blood_Plasma_Conc_Ratio = nah;
    Exp_Plasma_Fup = nah; % %
    CL = num2str(temp(j,3)); %L/h
    Vc = num2str(temp(j,4)); %L/kg
    K12 = num2str(temp(j,5)); %1/
    K21 = nah; %1/h
    K13 = nah; %1/h
    K31 = nah; %1/h
    Renal_clearance = nah; %L/h/kg
...
reorder=vertcat(A(1,:),A(6,:),A(2,:),A(4:5,:),A(3,:));
reorder_names=vertcat(names(1,:),names(6,:),names(2,:),names(4:5,:),names(3,:));
...
% title('(A) Acetaminophen C_{max} First Order and Total Effects','FontSize',14)
set(gca,'XTickLabelRotation',0)

% %Second Order Effects - Cmax
% A = func_Sij(:,:,1);
% reorder_rows=vertcat(A(1,:),A(6,:),A(2,:),A(4:5,:),A(3,:));
% reorder=horzcat(reorder_rows(:,1),reorder_rows(:,6),reorder_rows(:,2),reorder_rows(:,4:5),reorder_rows(:,3));
...
% ylabel('Input Factors','FontSize',16,'FontWeight','bold');
% % title('(B) Acetaminophen C_{max} Second Order Effects','Fontsize',14)
% set(gca,'XTickLabelRotation',45)
% %First Order Effects - Cmax
% A = horzcat(func_SiNew(:,1));
% XaxisArray = {'C_{max}'};
% YaxisArray = names;
% figure()
% imagesc(A)
...
% title('APAP IR Tablets - First Order Effects')
% set(gca,'XTickLabelRotation',45)
% 
% % Total Effects -Cmax
...
% ylabel('Input Factors');
% title('APAP IR Tablet - Second Order Effects - C_{max}')
% set(gca,'XTickLabelRotation',45)
